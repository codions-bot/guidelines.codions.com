@component('layouts.app')
    <section class="home">
        ...
        <section class="home__introduction">
            ...
            <p>
                All pages are hosted on <a href="https://github.com/codions/guidelines.codions.com" target="spatie">GitHub</a>, so edits and improvements are welcome. Note that these are our own opinionated ideas, so we'll be finicky when it comes to substantial changes.
            </p>
        </section>
